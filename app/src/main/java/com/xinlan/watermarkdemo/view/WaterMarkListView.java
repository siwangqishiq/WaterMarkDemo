...
public class WaterMarkListView extends ListView {
    ...
    public WaterMarkListView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public WaterMarkListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
